...
Mat finddelta(Mat** DoG, int x, int y, int lv, int s, int w, int h);//(module - 3에 포함, loop X)
//(module - 3)
void FindLocalExtrema(Mat** DoG, int level, int size, int w, int h, int** idx); // 4중for문 有
//(module - 4)
